...
// #include <cucumber-cpp/internal/Scenario.hpp> // Often not needed for basic World access
...
GIVEN("^a stable provider with retrievable context is registered$") {
    ...
    // In C++, the transaction context propagation is usually handled differently or isn't a direct API call like in Java.
    // For now, we omit the ThreadLocalTransactionContextPropagator equivalent.
}
