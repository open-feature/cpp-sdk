...
struct ScenarioState {
    ...
    Flag flag;
    openfeature::EvaluationContext ctx = openfeature::EvaluationContext::Builder().build();
    //FlagEvaluationDetails eval
    //MockHook hook
    std::shared_ptr<openfeature::FeatureProvider> provider;
    openfeature::EvaluationContext invocation_ctx = openfeature::EvaluationContext::Builder().build();
